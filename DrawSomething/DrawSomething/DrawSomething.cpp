// DrawSomething.cpp : 응용 프로그램에 대한 진입점을 정의합니다.
//
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_DRAWSOMETHING);
    ...
    case WM_PAINT:
        {
			...
			Ellipse(hdc, 600, 100, 700, 200);

			//얼굴통
			Ellipse(hdc, 400, 100, 700, 300);

			//코통
			Ellipse(hdc, 600, 200, 500, 285);
			
			//콧등
			Ellipse(hdc, 530, 240, 570, 270);

			//눈
			Ellipse(hdc, 460, 150, 510, 200);
			Ellipse(hdc, 590, 150, 640, 200);

			//눈알
			Ellipse(hdc, 470, 160, 500, 190);
			Ellipse(hdc, 600, 160, 630, 190);
